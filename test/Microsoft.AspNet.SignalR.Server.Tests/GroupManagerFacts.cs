    ...
    public class GroupManagerFacts
    {
        public class Add
        {
            ...
            public void ThrowsIfConnectionIdIsNull()
            {
                ...
                // Assert
                Assert.ThrowsAsync<ArgumentNullException>(() => groupManager.Add(null, "SomeGroup"));
            }
            ...
            public void ThrowsIfGroupIsNull()
            {
                ...
                // Assert
                Assert.ThrowsAsync<ArgumentNullException>(() => groupManager.Add("1", null));
            }
        ...
        public class Remove
        {
            ...
            public void ThrowsIfGroupIsNull()
            {
                ...
                // Assert
                Assert.ThrowsAsync<ArgumentNullException>(() => groupManager.Remove("1", null));
            }
        ...
        public class Send
        {
            ...
            public void ThrowsIfGroupIsNull()
            {
                ...
                // Assert
                Assert.ThrowsAsync<ArgumentException>(() => groupManager.Send((string)null, "Way"));
            }
